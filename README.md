...
change a skill. Fresh captures of the same skill can be compared explicitly with
`--variability`, helping check how much verdicts move before attributing a
difference to a skill edit. See [the evaluation guide](docs/skill-evaluation.md) for real-run
